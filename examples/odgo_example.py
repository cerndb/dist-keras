"""
Example of experimental distributed gradient optimization using dist-keras.
...
from distkeras.distributed import ODGO
...
ensembleTrainer = ODGO(model, features_col="features_normalized", num_workers=2)
model = ensembleTrainer.train(trainingSet)
print(model)
